...
#define MC_GET_PIN_TIMER_(IO) ((DIO ## IO ## _PWM)
...
#define MC_GET_PIN_TIMER(IO) MC_GET_PIN_TIMER_(IO)
...
#define DIO5_PWM            &OC3A

#define DIO6_PIN            PIND7
#define DIO6_RPORT          PIND
#define DIO6_WPORT          PORTD
#define DIO6_DDR            DDRD
#define DIO6_PWM            &OC4D
...
#define DIO9_WPORT          PORTB
#define DIO9_DDR            DDRB
#define DIO9_PWM            &OC1A

#define DIO10_PIN           PINB6
#define DIO10_RPORT         PINB
#define DIO10_WPORT         PORTB
#define DIO10_DDR           DDRB
#define DIO10_PWM           &OC1B

#define DIO11_PIN           PINB7
#define DIO11_RPORT         PINB
#define DIO11_WPORT         PORTB
#define DIO11_DDR           DDRB
#define DIO11_PWM           &OC1C
